package com.example.urticare20.util
...
object MilestoneEvaluator {
    ...
    data class PastMilestone(
        val type: com.example.urticare20.viewmodel.MilestoneType,
            ...
            for (i in 0 until meds.size - 1) {
                ...
                try {
                    ...
                    if (hours >= 48L) {
                        ...
                        list.add(
                            PastMilestone(
                                type = com.example.urticare20.viewmodel.MilestoneType.ADHERENCE,
                                value = hours,
            ...
            for (i in 0 until flares.size - 1) {
                ...
                try {
                    ...
                    if (days >= 7L) {
                        ...
                        list.add(
                            PastMilestone(
                                type = com.example.urticare20.viewmodel.MilestoneType.REMISSION,
                                value = days,
                                dateCompletedStr = dateCompletedStr,
                                reasonStopped = reason,
                                completionTime = t1
